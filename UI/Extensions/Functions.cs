    ...
    public class Functions
    {
        ...
        public static void WriteMenu(List<ModuleRoleDTO> modules,int userId ,IWebHostEnvironment environment)
        {
            ...
            if (modules != null)
            {
                ...
                menuTxt += "  <li class=\"nav-item\">\r\n     <a class=\"nav-link menu-link\" href=\"" + firstModule.ModuleDTO.Action + "\"  role=\"button\"\r\n " +
                    "aria-expanded=\"false\" aria-controls=\"sidebarDashboards\">\r\n" +
                    "<i class='" + firstModule.ModuleDTO.Icon + "'></i><span >" + firstModule.ModuleDTO.Name + "</span>\r\n   " +
                    "</a>\r\n\r\n </li> ";
                ...
                foreach (var item in modules)
                {
                    ...
                    {
                        if (item.ModuleDTO.SubModules.Count < 1)
                        {
                            menuTxt += "  <li class=\"nav-item\">\r\n     <a class=\"nav-link menu-link\" href=\"" + item.ModuleDTO.Action + "\"  role=\"button\"\r\n " +
                     "aria-expanded=\"false\" aria-controls=\"sidebarDashboards\">\r\n" +
                     "<i class='" + item.ModuleDTO.Icon + "'></i><span >" + item.ModuleDTO.Name + "</span>\r\n   " +
                     "</a>\r\n\r\n </li> ";
                        }
                        else
                        {
                            menuTxt += "<li class=\"nav-item\">\r\n" +
                                "<a class=\"nav-link menu-link\" href=\"#sidebarDashboards" + item.Id + "\" data-bs-toggle=\"collapse\" role=\"button\"\r\n" +
                                "aria-expanded=\"false\">\r\n" +
                                "<i class='" + item.ModuleDTO.Icon + "'></i> <span >" + item.ModuleDTO.Name + "</span>\r\n   " +
                                "</a>\r\n" +
                                "<div class=\"collapse menu-dropdown\" id=\"sidebarDashboards" + item.Id + "\">\r\n" +
                            ...
                            foreach (ModuleDTO altItem in item.ModuleDTO.SubModules)
                            {
                                ...
                                {
                                    menuTxt += "<li class=\"nav-item\">\r\n                <a href=\"" + altItem.Action + "\" class=\"nav-link\"> " + altItem.Name + " </a>\r\n            </li>";
                                }
                            }
                            menuTxt += " </ul></div></li> ";
        ...
        public static void WriteUserInformation(UserModel user, RoleDTO role, IWebHostEnvironment environment)
        {
            ...
            if (user != null)
            {
                userTxt += " <span class=\"d-none d-xl-inline-block ms-1 fw-medium user-name-text\">" + user.Phone + /* " "+ user.Surname +*/ "</span>\n" +
                    "<span class=\"d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text\">" + role.Name + "</span>";
            }
